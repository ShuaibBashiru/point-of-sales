...
<div class="col-md-12 mt-4">
    <div class="row">
        ...
        <div class="col-3 mt-4 d-flex position-relative" v-for="(d, index) in info" :key="index">
        <div class="m-1 me-4">
        ...
        <section v-if="d.read_more_status==1" class="mt-3">
            <a :href="'#/'+index" style="text-underline-position: under;" class="float-start stretched-link" v-if="d.read_more_type=='TextLink'"> <u><span v-text="d.read_more_title"></span></u>  </a>
            <a :href="'#/'+index" class="btn btn-primary float-start stretched-link" v-else v-text="d.read_more_title">  </a>
        </section>
    </div>
        </div>
        </Vslick>
...
export default {
  name: 'courses-slideshow',
    ...
    return{
        ...
        content_header: {
            header_title: "Learn the essential skills to explore the digital world.",
            header_text: '',
        },
        info: [],
        content: {
