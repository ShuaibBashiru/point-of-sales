...
<form method="post" action="" enctype="multipart/form-data">
        <div class="form-group mt-2">
             ...
             <select v-model="parameters.category_id" class="form-control shadow-none">
        ...
        <div class="form-group col mt-3">
            ...
            <textarea id="summary" placeholder="Enter your content summary" class="form-control mt-1 mb-1" @keyup="oneSpace('post_summary')" v-model="parameters.post_summary" rows="3" required></textarea>
    ...
    <div class="col-12">
       <div class="form-group mt-3">
        <div class="row">
            ...
            <div class="col"><button class="btn btn-primary btn-sm float-end m-1 mb-3" @click="generateLink">Generate</button></div>
        </div>
        </div>
...
export default {
    ...
    getRecord: function(){
        ...
        this.parameters.post_summary = this.info.post_summary
        this.parameters.post_body = this.info.post_body
   ...
   validatePost: function(){
        this.errors = '';
        if(this.parameters.title=="" || this.parameters.post_summary=="" || this.parameters.category_id=="") {
            this.validated = false
            this.disabled = false;
            this.parameters.post_link = ''
            this.alertMsg='Kindly fill the category, title and summary content.'
